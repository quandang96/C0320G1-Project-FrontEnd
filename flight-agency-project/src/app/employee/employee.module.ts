...
@NgModule({
  declarations: [BookTicketComponent, BookTicketStep1Component, BookTicketStep2Component, BookTicketStep3Component, FindFlightComponent, AddPassengerComponent, UpdatePassengerComponent, ListPassengerComponent],
  imports: [
    CommonModule,
